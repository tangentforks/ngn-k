...
A3(arf,/*011*/Q(xtv)Q(xv<11)Q(!y||ytzfc)Q(ztZFC)
 ...
 ZB(z=cG(z);arf(x,y,z))
 z(G(&dexf,admf,subf,admf,___f,___f,mmmf,mmmf,___f,___f,___f)[xv](x,y,z)))
...
A3(ars,/*011*/Q(xtv)Q(xv<11)Q(!y||ytzc)Q(ztZC)
 ZE(z=gZ(z);ars(x,y,z))
 ZB(z=cG(z);ars(x,y,z))
 z(G(&dexs,adms,subs,adms,___s,___s,mnms,mxms,___s,___s,eqls)[xv](x,y,z)))
...
A3(arp,/*011*/Q(xtv)Q(xv<11)Q(ytzc)Q(ztZC)
 ZE(z=gZ(z);arp(x,y,z))
 ZB(z=cG(z);arp(x,y,z))
 z(G(&dexp,___p,___p,___p,___p,modp,mnmp,mxmp,cmpp,cmpp,cmpp)[xv](x,y,z)))
