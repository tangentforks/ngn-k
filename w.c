...
Z A3(ls2,/*011*/Y(Ril(ns(x,gl(y),z))RU(y(ws(x,y,z)))R_(et(z(y))))0)
Z A3(lf2,/*011*/Y(Ril(nf(x,gl(y),z))RU(y(wf(x,y,z)))R_(et(z(y))))0)
...
Z A2(f1,/*01*/Yt(y)P(xtv&&xv<11&&ytZFC,arf(x,0,y))P(x==CAT,raz(y))P(!yN,y(ie(x,y)))A z=ii(y,0);F(yN-1,z=x2(z,ii(y,i+1));B(!z))y(z))
Z A3(f2,/*011*/Zt(x2(y,z))P(xtv&&xv<11&&ytzfc&&ztZFC,arf(x,y,z))P(x==CAT,raz(N(cat11(enl(y),z))))P(xto||xtp,F(zN,y=N(x8(A8(y,ii(z,i)),2)))z(y))F(zN,y=x2(y,ii(z,i));B(!y))z(y))
...
Z A3(s2,/*011*/Zt(x2(y,z))Zm(A u=N(s2(x,y,zy),zy=au;z(0));y=am(zx,u);zy=zx=au;z(y))P(!zN,y(z))P(xtv&&xv<11&&ytzc&&ztZC,ars(x,y,z))A u=emp(tA);F(zN,y=x2(y,ii(z,i));P(!y,z(u(0)))PSH(u,yR))z(y(u)))
Z A2(s1,/*01*/Yt(y)P(!yN,y)Ym(A z=kv(&y);am(y,Ny(s1(x,z))))P(x==CAT,s2(x,emp(tA),y))P(xtv&&xv<11&&ytZC,ars(x,0,y))
...
Z A3(p2,/*011*/Zt(er(y))Zm(y=N(p2(x,y,zy),zy=au;z(0));y=am(zx,y);zy=zx=au;z(y))P(!zN,y(z))P(xtv&&xv<11&&ytzc&&ztZC,arp(x,y,z))A u=emp(tA);F(zN,A v=ii(z,i),r;N(r=x2(_R(v),y),z(u(0)));y=v;PSH(u,r))z(y(u)))
