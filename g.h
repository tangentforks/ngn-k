...
#define xtMT _tMT(x)
#define xtzf _tzf(x)
#define xtzfs _tzfs(x)
#define xtzfsc _tzfsc(x)
#define xtZF _tZF(x)
#define xtZFS _tZFS(x)
#define xtZFSC _tZFSC(x)
#define xtzc _tzc(x)
...
#define ytMT _tMT(y)
#define ytzf _tzf(y)
#define ytzfs _tzfs(y)
#define ytzfsc _tzfsc(y)
#define ytZF _tZF(y)
#define ytZFS _tZFS(y)
#define ytZFSC _tZFSC(y)
#define ytzc _tzc(y)
...
#define ztMT _tMT(z)
#define ztzf _tzf(z)
#define ztzfs _tzfs(z)
#define ztzfsc _tzfsc(z)
#define ztZF _tZF(z)
#define ztZFS _tZFS(z)
#define ztZFSC _tZFSC(z)
#define ztzc _tzc(z)
...
#define utMT _tMT(u)
#define utzf _tzf(u)
#define utzfs _tzfs(u)
#define utzfsc _tzfsc(u)
#define utZF _tZF(u)
#define utZFS _tZFS(u)
#define utZFSC _tZFSC(u)
#define utzc _tzc(u)
...
#define Xzfs(a...) P(xtzfs,a)
#define Xzfsc(a...) P(xtzfsc,a)
#define XZF(a...) P(xtZF,a)
#define XZFS(a...) P(xtZFS,a)
#define XZFSC(a...) P(xtZFSC,a)
...
#define Yzfs(a...) P(ytzfs,a)
#define Yzfsc(a...) P(ytzfsc,a)
#define YZF(a...) P(ytZF,a)
#define YZFS(a...) P(ytZFS,a)
#define YZFSC(a...) P(ytZFSC,a)
...
#define Zzfs(a...) P(ztzfs,a)
#define Zzfsc(a...) P(ztzfsc,a)
#define ZZF(a...) P(ztZF,a)
#define ZZFS(a...) P(ztZFS,a)
#define ZZFSC(a...) P(ztZFSC,a)
...
#define _tzfs(x) (_tzf(x)||_ts(x))
#define _tzfsc(x) (_tzfs(x)||_tc(x))
#define _tZF(x) (_tZ(x)||_tF(x))
#define _tZFS(x) (_tZF(x)||_tS(x))
#define _tZFSC(x) (_tZFS(x)||_tC(x))
